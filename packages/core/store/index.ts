 ...
 *
 * Shared between the mobile and desktop apps (@spal/core/store). Both read
 * user/activeBusiness/businesses/recordSavedAt from here — whichever app's
 * screen wrote the state, the other reads the same values.
 */
import { create } from "zustand";
import { persist } from "zustand/middleware";
import type { Business, CoachGoal } from "../lib/types";

/** Minimal shape needed to hold a just-earned badge for the celebration overlay — the
 *  full badge-checking logic (Supabase-backed) stays app-side, not in the shared core. */
