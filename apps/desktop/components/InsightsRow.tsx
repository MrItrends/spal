...
import type { InsightItem, InsightTone } from "@spal/core/lib/insights";
...
/** Desktop insights: a wrapping 2-up grid (the extra width fits two cards at once, so no carousel/dots). */
