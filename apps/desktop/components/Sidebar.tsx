...
/** Fixed left sidebar — same destinations as the mobile tab bar, business-mode aware. */
export function Sidebar() {
  ...
  return (
    <aside className="flex flex-col w-[248px] shrink-0 h-full overflow-y-auto" style={{ background: "#0F172A" }} aria-label="Primary">
      <div className="px-6 pt-8 pb-6 flex items-center gap-2.5">
        <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: "#22C55E" }}>
          <span className="text-[14px] font-black" style={{ color: "#0F172A", fontFamily: FF }}>S</span>
        </div>
