...
import {
  Notification03Icon, User02Icon, Home01Icon, Menu01Icon, BarChartIcon, ArrowLeft01Icon,
    ...
    <>
      <div className="min-h-full" style={{ background: BG }}>
        ...
        <div className="px-5 pt-12 flex items-center gap-3">
          ...
          <h1 className="text-[22px] font-black text-spal-navy" style={{ fontFamily: "var(--font-satoshi)" }}>Records</h1>
        </div>
