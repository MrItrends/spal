...
const METHODS = [
  {
    label: "Manual Entry",
    sub: "Type in your expense details quickly",
    href: "/records/add-expense/manual",
  ...
  },
  {
    ...
    href: "/records/add-expense/voice",
  ...
  },
  {
    ...
    href: "/records/add-expense/picture",
  ...
  },
  {
    ...
    href: "/records/add-expense/import",
    ...
    <div className="min-h-full" style={{ background: BG, fontFamily }}>
      ...
      <div className="px-5 pb-8">
        ...
        <p className="text-[13.5px] text-neutral-500 mt-1.5 leading-relaxed" style={{ fontFamily }}>
          SPAL captures your expense details automatically, just pick your preferred way
        </p>
        ...
        >
          <p className="text-[12.5px] leading-relaxed" style={{ fontFamily, color: "#B45309" }}>
            💡 SPAL can read receipts, voice notes, and photos of your bills, saving you from typing everything manually.
          </p>
        </motion.div>
      </div>
    </div>
