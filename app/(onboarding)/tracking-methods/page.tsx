...
const METHODS: {
...
}[] = [
  {
    method: "notebook",
    label: "Notebook",
    sub: "You write records in a physical notebook",
    icon: <NotebookIcon />,
    accent: "#22C55E",
  },
  {
    method: "whatsapp",
    label: "WhatsApp",
    sub: "You message yourself or save notes on WhatsApp",
    icon: <WhatsAppIcon />,
    accent: "#F97316",
  },
  {
    ...
    sub: "You track your records in a spreadsheet",
    icon: <ExcelIcon />,
    accent: "#8B5CF6",
  },
  {
    ...
    label: "Google Sheets",
    sub: "You use Google Sheets to track your business",
    icon: <SheetsIcon />,
    accent: "#2563EB",
  },
  {
    method: "notes_app",
    label: "Notes App",
    sub: "You use a notes app on your phone",
    icon: <NotesAppIcon />,
    accent: "#22C55E",
  },
  {
    method: "receipts",
    label: "Receipts",
    sub: "You keep paper receipts or photos of them",
    icon: <ReceiptsIcon />,
    accent: "#F97316",
  },
  {
    ...
    sub: "No system yet. SPAL will help you start.",
    icon: <NothingIcon />,
    accent: "#A1A1AA",
    exclusive: true,
  },
